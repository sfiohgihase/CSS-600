...
foreach gis:feature-list-of mex_districts [ [vector-feature] ->
      ...
      [ create-district-labels 1
        [ set xcor item 0 centroid
          ...
          set label-color black  ;; add country names on map
          set label district-name-label  ;; add country names on map
          set pop-2015 gis:property-value vector-feature "POP_2015"
      ]]]
...
; UPDATE THE DISPLAY CHOICES FOR THE
to update-display
...
pop-display
pop-display
"Mexico" "All" "Belize" "Honduras" "Guatemala" "El Salvador"
3
